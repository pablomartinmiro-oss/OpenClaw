    ...
    <div className="flex h-full flex-col overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="flex-1 space-y-5 p-6">
        ...
        <fieldset className="space-y-3">
          ...
          <input
            type="text" placeholder="Nombre completo *" value={form.clientName}
          ...
          <div className="grid grid-cols-2 gap-3">
            <input
              type="email" placeholder="Email" value={form.clientEmail}
            ...
            />
            <input
              type="tel" placeholder="Teléfono" value={form.clientPhone}
              onChange={(e) => set("clientPhone", e.target.value)}
              className="rounded-lg border border-border bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coral"
            />
          </div>
          <textarea
            placeholder="Notas del cliente (opcional)" value={form.clientNotes}
            onChange={(e) => set("clientNotes", e.target.value)} rows={2}
        ...
        <fieldset className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number" min={1} value={form.adults} onChange={(e) => set("adults", Number(e.target.value))}
                className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coral"
              />
            </div>
            <div>
              ...
              <input
                type="number" min={0} value={form.children} onChange={(e) => set("children", Number(e.target.value))}
                className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-coral"
              />
            </div>
          </div>
        ...
        <fieldset className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <label key={key} className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm cursor-pointer hover:bg-warm-muted">
                <input
                  type="checkbox"
        ...
        <button
          type="submit" disabled={createQuote.isPending}
