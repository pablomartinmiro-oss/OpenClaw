    ...
    return (
      <div className="mx-auto max-w-xl px-4 sm:px-6 py-20 sm:py-28 text-center">
        ...
        <p className="text-gray-500 mb-6 max-w-sm mx-auto">
          Explora nuestras experiencias y anade lo que mas te guste.
        </p>
        <Link
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-5">
            <div className="flex items-center gap-2 mb-3">
              <TagIcon />
              <span className="text-sm font-semibold text-gray-900">Codigo de descuento</span>
            </div>
            {discountCode ? (
              ...
              <>
                <div className="flex gap-2">
                  <input type="text" value={codeInput} onChange={(e) => setCodeInput(e.target.value.toUpperCase())} onKeyDown={(e) => e.key === "Enter" && handleApplyCode()} placeholder="Introduce tu codigo de descuento" className="flex-1 px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E87B5A]/30 focus:border-[#E87B5A]" />
          ...
          <div className="sticky top-24 rounded-xl border border-gray-200 bg-white p-6">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Subtotal ({itemTotal} articulos)</span>
